...
#ifndef ISOMETRICNEW_RENDERMODES_H_
#define ISOMETRICNEW_RENDERMODES_H_

namespace mapcrafter {
namespace renderer {

class NewIsometricLightingRenderer : public LightingRenderer {
public:
	virtual ~NewIsometricLightingRenderer();
...
class NewIsometricOverlayRenderer : public OverlayRenderer {
public:
...
#endif /* ISOMETRICNEW_RENDERMODES_H_ */
