...
#ifndef SIDE_RENDERMODES_H_
#define SIDE_RENDERMODES_H_

namespace mapcrafter {
namespace renderer {

class SideLightingRenderer : public LightingRenderer {
public:
	virtual ~SideLightingRenderer();
...
class SideOverlayRenderer : public OverlayRenderer {
public:
