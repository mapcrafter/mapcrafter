...
RGBAImage IsometricBlockImages::buildStairsSouth(const RGBAImage& texture,
...
RGBAImage IsometricBlockImages::buildStairsNorth(const RGBAImage& texture,
		const RGBAImage& texture_top) {
	RGBAImage block(texture_size * 2, texture_size * 2);
	for (TopFaceIterator it(texture_size); !it.end(); it.next()) {
...
RGBAImage IsometricBlockImages::buildStairsWest(const RGBAImage& texture,
		const RGBAImage& texture_top) {
	RGBAImage block(texture_size * 2, texture_size * 2);
	for (TopFaceIterator it(texture_size); !it.end(); it.next()) {
...
RGBAImage IsometricBlockImages::buildStairsEast(const RGBAImage& texture,
		const RGBAImage& texture_top) {
	RGBAImage block(texture_size * 2, texture_size * 2);
	for (TopFaceIterator it(texture_size); !it.end(); it.next()) {
