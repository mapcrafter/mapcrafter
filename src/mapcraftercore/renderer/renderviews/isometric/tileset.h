...
#ifndef ISOMETRIC_TILESET_H_
#define ISOMETRIC_TILESET_H_
 ...
 *
 * The IsometricTileSet class manages the tiles for the rendering process. The render tiles are
...
public:
	IsometricTileSet();
	IsometricTileSet(const mc::World& World);
	~IsometricTileSet();
