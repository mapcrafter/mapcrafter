...
IsometricTileRenderer::IsometricTileRenderer(std::shared_ptr<mc::WorldCache> world,
 ...
 */
uint16_t IsometricTileRenderer::checkNeighbors(const mc::BlockPos& pos, uint16_t id, uint16_t data) {
...
void IsometricTileRenderer::renderTile(const TilePos& tile_pos, const TilePos& tile_offset,
		RGBAImage& tile) {
