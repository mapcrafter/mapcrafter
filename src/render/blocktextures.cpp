...
BlockTextures::BlockTextures()
	: ANVIL_BASE("anvil_base"),
	  ...
	  LEAVES_ACACIA_OPAQUE("leaves_acacia_opaque"),
	  LEAVES_BIG_OAK("leaves_big_oak"),
	  LEAVES_BIG_OAK_OPAQUE("leaves_big_oak_opaque"),
	  LEAVES_BIRCH("leaves_birch"),
	  LEAVES_BIRCH_OPAQUE("leaves_birch_opaque"),
	  LEAVES_JUNGLE("leaves_jungle"),
	  LEAVES_JUNGLE_OPAQUE("leaves_jungle_opaque"),
	  LEAVES_OAK("leaves_oak"),
	  LEAVES_OAK_OPAQUE("leaves_oak_opaque"),
