...
public:
	...
	TextureImage ANVIL_BASE, ANVIL_TOP_DAMAGED_0, ANVIL_TOP_DAMAGED_1,
			...
			DIAMOND_BLOCK, DIAMOND_ORE, DIRT, DISPENSER_FRONT_HORIZONTAL,
			DISPENSER_FRONT_VERTICAL, DOOR_IRON_LOWER, DOOR_IRON_UPPER, DOOR_WOOD_LOWER,
			DOOR_WOOD_UPPER, DRAGON_EGG, DROPPER_FRONT_HORIZONTAL, DROPPER_FRONT_VERTICAL,
			EMERALD_BLOCK, EMERALD_ORE, ENCHANTING_TABLE_BOTTOM, ENCHANTING_TABLE_SIDE,
			ENCHANTING_TABLE_TOP, END_STONE, ENDFRAME_EYE, ENDFRAME_SIDE, ENDFRAME_TOP,
			FARMLAND_DRY, FARMLAND_WET, FERN, FIRE_LAYER_0, FIRE_LAYER_1,
			FLOWER_DANDELION, FLOWER_POT, FLOWER_ROSE, FURNACE_FRONT_OFF,
			FURNACE_FRONT_ON, FURNACE_SIDE, FURNACE_TOP, GLASS, GLASS_PANE_TOP, GLOWSTONE,
			GOLD_BLOCK, GOLD_ORE, GRASS_SIDE, GRASS_SIDE_OVERLAY, GRASS_SIDE_SNOWED,
			...
			HARDENED_CLAY_STAINED_YELLOW, HAY_BLOCK_SIDE, HAY_BLOCK_TOP, HOPPER_INSIDE,
			HOPPER_OUTSIDE, HOPPER_TOP, ICE, IRON_BARS, IRON_BLOCK, IRON_ORE,
			ITEMFRAME_BACKGROUND, JUKEBOX_SIDE, JUKEBOX_TOP, LADDER, LAPIS_BLOCK,
			LAPIS_ORE, LAVA_FLOW, LAVA_STILL, LEAVES_BIRCH, LEAVES_BIRCH_OPAQUE,
			LEAVES_JUNGLE, LEAVES_JUNGLE_OPAQUE, LEAVES_OAK, LEAVES_OAK_OPAQUE,
			LEAVES_SPRUCE, LEAVES_SPRUCE_OPAQUE, LEVER, LOG_BIRCH, LOG_BIRCH_TOP,
			LOG_JUNGLE, LOG_JUNGLE_TOP, LOG_OAK, LOG_OAK_TOP, LOG_SPRUCE, LOG_SPRUCE_TOP,
			MELON_SIDE, MELON_STEM_CONNECTED, MELON_STEM_DISCONNECTED, MELON_TOP,
			MOB_SPAWNER, MUSHROOM_BLOCK_INSIDE, MUSHROOM_BLOCK_SKIN_BROWN,
			MUSHROOM_BLOCK_SKIN_RED, MUSHROOM_BLOCK_SKIN_STEM, MUSHROOM_BROWN,
			MUSHROOM_RED, MYCELIUM_SIDE, MYCELIUM_TOP, NETHER_BRICK, NETHER_WART_STAGE_0,
			NETHER_WART_STAGE_1, NETHER_WART_STAGE_2, NETHERRACK, NOTEBLOCK, OBSIDIAN,
			PISTON_BOTTOM, PISTON_INNER, PISTON_SIDE, PISTON_TOP_NORMAL,
			PISTON_TOP_STICKY, PLANKS_BIRCH, PLANKS_JUNGLE, PLANKS_OAK, PLANKS_SPRUCE,
			PORTAL, POTATOES_STAGE_0, POTATOES_STAGE_1, POTATOES_STAGE_2,
